              ...
              <div className="text-left">
                ...
                <div className="space-y-3 text-sm text-neutral-700">
                  <p className="font-semibold">
                    # PRD: User Dashboard Enhancement
                  </p>
                  <p>## Overview</p>
                  <p>
                    Add real-time analytics and filtering capabilities to the
                    existing user dashboard...
                  </p>
                  <p>## Core Features</p>
                  <p>
                    **Real-time Data Updates**: Integrate with current WebSocket
                    infrastructure (packages/api/src/wsHub.js) to provide live
                    metrics...
                  </p>
                  <p>## Technical Architecture</p>
                  <p>
                    Based on existing React/TypeScript patterns, implement new
                    dashboard components following the established structure in
                    packages/web/src/components...
                  </p>
                  <div className="bg-green-50 border-l-4 border-green-400 p-3 mt-4">
                    <p className="text-green-800 text-xs">
                      ✓ Generated by analyzing your actual codebase structure
                    </p>
                  </div>
                </div>
              </div>
